...
> **Быстрый способ:** Используйте scaffold-генератор: `npm run create-page <slug>` — он автоматически создаст JSON-файл страницы, SEO-файл и добавит маршрут в `config/project.php`.
